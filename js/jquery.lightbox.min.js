...
switch(step)
{case 1:this.KeyboardNav_Disable();$('#lightbox-loading').show();$('#lightbox-image,#lightbox-nav,#lightbox-nav-btnPrev,#lightbox-nav-btnNext,#lightbox-infoBox').hide();$('#lightbox-image').attr('src','');$('#lightbox-imageBox').unbind();if(!this.images.active(image)){return false;}
